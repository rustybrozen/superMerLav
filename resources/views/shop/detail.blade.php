...
<x-layout :title="'Chi tiết sản phẩm'">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="flex space-x-3 overflow-x-auto pb-2">
              ...
              >
              <img 
                src="https://images.unsplash.com/photo-1619546813926-a78fa6372cd2?w=150&h=150&fit=crop" 
                alt="Apple Image 2" 
              ...
              >
              <img 
                src="https://images.unsplash.com/photo-1570913149827-d2ac84ab3f9a?w=150&h=150&fit=crop" 
                alt="Apple Image 3" 
                class="w-16 h-16 rounded-lg object-cover cursor-pointer ring-2 ring-transparent hover:ring-green-300 opacity-75 hover:opacity-100 transition-all flex-shrink-0"
                onclick="changeMainImage(this.src.replace('w=150&h=150', 'w=600&h=600'))"
              >
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-center space-x-4">
              ...
              <span class="font-semibold text-gray-800 bg-gray-100 px-3 py-1 rounded-full">{{ $product->quantity }}</span>
            </div>
            ...
            <div class="bg-gray-50 p-6 rounded-lg">
              <form class="space-y-4">
                <div class="flex items-center space-x-4">
                  ...
                  <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                    <button type="button" class="px-3 py-2 bg-gray-100 hover:bg-gray-200 transition-colors" onclick="decreaseQuantity()">
                    ...
                    >
                    <button type="button" class="px-3 py-2 bg-gray-100 hover:bg-gray-200 transition-colors" onclick="increaseQuantity()">
              ...
              {{-- Success Alert --}}
              <div id="successAlert" class="hidden mt-4 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg">
  ...
  <script>
    ...
    function changeMainImage(newSrc) {
      ...
      event.target.className = event.target.className.replace('ring-transparent opacity-75', 'ring-green-500 opacity-100');
    }
